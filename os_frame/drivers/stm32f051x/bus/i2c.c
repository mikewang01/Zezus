...
/*trigger and read humidity data from sensor*/			
		  case TRIGGER_HUMI_MEASUREMENT: htu20_read_data(htu20_dev->dev_adress , TRIGGER_HUMI_MEASUREMENT , args , 3); break;
/*trigger and read temperature data from sensor*/			
			case TRIGGER_TEMP_MEASUREMENT: htu20_read_data(htu20_dev->dev_adress , TRIGGER_TEMP_MEASUREMENT , args , 3); break;
/*read user register data*/			
			case READ_USER_REGISTER:       htu20_read_data(htu20_dev->dev_adress , READ_USER_REGISTER       , args , 1); break;
			
		  case WRITE_USER_REGISTER:      htu20_send_data(htu20_dev->dev_adress , WRITE_USER_REGISTER      , args    );  break;
/*reset sensor via software*/			
			case SOFT_RESET:  						 htu20_send_data(htu20_dev->dev_adress , SOFT_RESET , args );          break;    
			default:break;
