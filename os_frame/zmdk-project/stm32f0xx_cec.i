...
#line 93 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_cec.c"
...
#line 94 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_cec.c"
...
#line 95 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_cec.c"
...
void CEC_Init(CEC_InitTypeDef* CEC_InitStruct)
{
  ...
  tmpreg = ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CFGR;

   
  tmpreg &= ((uint32_t)0x7000FE00);
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CFGR = tmpreg;
}
...
void CEC_StructInit(CEC_InitTypeDef* CEC_InitStruct)
{
  CEC_InitStruct->CEC_SignalFreeTime = ((uint32_t)0x00000000);
  CEC_InitStruct->CEC_RxTolerance = ((uint32_t)0x00000000);
  CEC_InitStruct->CEC_StopReception = ((uint32_t)0x00000000);
  CEC_InitStruct->CEC_BitRisingError = ((uint32_t)0x00000000);
  CEC_InitStruct->CEC_LongBitPeriodError = ((uint32_t)0x00000000);
  CEC_InitStruct->CEC_BRDNoGen = ((uint32_t)0x00000000);
  CEC_InitStruct->CEC_SFTOption = ((uint32_t)0x00000000);
}
...
void CEC_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CR |= ((uint32_t)0x00000001);
  }
  else
  {
...
void CEC_ListenModeCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CFGR |= ((uint32_t)0x80000000);
  }
  else
  {
...
void CEC_OwnAddressConfig(uint8_t CEC_OwnAddress)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CFGR |= tmp;
}
...
void CEC_OwnAddressClear(void)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CFGR = 0x0;
}
...
void CEC_SendData(uint8_t Data)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->TXDR = Data;
}
...
uint8_t CEC_ReceiveData(void)
{
  ...
  return (uint8_t)(((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->RXDR);
}
...
void CEC_StartOfMessage(void)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CR |= ((uint32_t)0x00000002); 
}
...
void CEC_EndOfMessage(void)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->CR |= ((uint32_t)0x00000004);
}
...
void CEC_ITConfig(uint16_t CEC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->IER |= CEC_IT;
  }
  else
  {
    CEC_IT =~CEC_IT;
...
FlagStatus CEC_GetFlagStatus(uint16_t CEC_FLAG) 
{
  ...
  if ((((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->ISR & CEC_FLAG) != (uint16_t)RESET)
  {
...
void CEC_ClearFlag(uint32_t CEC_FLAG)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->ISR = CEC_FLAG;
}
...
ITStatus CEC_GetITStatus(uint16_t CEC_IT)
{
  ...
  enablestatus = (((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->IER & CEC_IT);

   
  if (((((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->ISR & CEC_IT) != (uint32_t)RESET) && enablestatus)
  {
...
void CEC_ClearITPendingBit(uint16_t CEC_IT)
{
  ...
  ((CEC_TypeDef *) (((uint32_t)0x40000000) + 0x00007800))->ISR = CEC_IT;
}
