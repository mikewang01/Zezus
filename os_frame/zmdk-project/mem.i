...
#line 38 "..\\arch\\arm\\stm32f05x\\kernel\\mm\\mem.c"
#line 39 "..\\arch\\arm\\stm32f05x\\kernel\\mm\\mem.c"
...
void mem_init(void) 
{ 
    osmemset(mallco_dev.membase, 0, sizeof(mallco_dev.membase));
    mallco_dev.memrdy=1;
} 
...
{ 
    ...
    for(offset=1*1024/16-1;offset>=0;offset--)
    {    
        ...
        if(cmemb==nmemb)      
        {
            ...
            if(mallco_dev.mem_current_used>mallco_dev.mem_max_used) 
            {
...
{ 
    ...
    { 
        osmemcpy((void*)((u32)&mallco_dev.membase+offset),ptr,size);
        osfree(ptr);               
