...
#line 17 "..\\kernel\\clockmanager\\clockmanager.c"
...
#line 18 "..\\kernel\\clockmanager\\clockmanager.c"
...
#line 50 "..\\kernel\\clockmanager\\clockmanager.c"
    return SUCCESS;   
}
    ...
    }	else
    {
        ...
        while(obj!=0)
        {
            ...
            if(strcmp(name,obj->name)==0)
            {
                ...
                return ((Peripheral_clock *)( (char *)__mptr - ((size_t) &((Peripheral_clock *)0)->parent)));
            }
            
            obj++;			
            
        }
#line 94 "..\\kernel\\clockmanager\\clockmanager.c"
    }
    return 0;
} 
...
{  
    ...
    }else if(strcmp(name,"ALL")==0) 
    {
        ...
        while(__mptr!=0)
        {
            Peripheral_clock *phr_clock=((Peripheral_clock *)( (char *)__mptr - ((size_t) &((Peripheral_clock *)0)->parent)));
            if(phr_clock->clock_enable!=0&&phr_clock->pstatus_record->status!=clock_opened)
            {
...
#line 153 "..\\kernel\\clockmanager\\clockmanager.c"
    }else
    {
...
{  
    ...
    }else if(strcmp(name,"ALL")==0) 
    {
        ...
        {
            Peripheral_clock *phr_clock=((Peripheral_clock *)( (char *)__mptr - ((size_t) &((Peripheral_clock *)0)->parent)));
            if(phr_clock->clock_disable!=0&&phr_clock->pstatus_record->status!=clock_closed)
            {
...
#line 236 "..\\kernel\\clockmanager\\clockmanager.c"
    }else
    {
        Peripheral_clock *phr_clock=os_clock_get(name);
...
#line 338 "..\\kernel\\clockmanager\\clockmanager.c"
    }else
    {  
        Peripheral_clock *phr_clock=os_clock_get(name);
        u8 temp;
...
#line 383 "..\\kernel\\clockmanager\\clockmanager.c"
    }
    return SUCCESS;
}
...
void Sys_Standby(u8 var)
{
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APB1ENR |= 1<<28;             
    
    switch(var)
        
    {
    
    case sleepmode:{ break; }           
        
    case stopmode:{                    
        ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= 1<<2;      
        
        ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR  |= 1<<0;      
    ...
    case standbymode:{                    
        ...
        ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR|=1<<1;          
    ...
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CR  |= 1<<2;                  
    ((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x00007000))->CSR |= 1<<8;                  
