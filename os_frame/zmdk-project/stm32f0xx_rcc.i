...
#line 59 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_rcc.c"
...
#line 60 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_rcc.c"
  ...
  switch (tmp)
  {
    ...
    case 0x08:   
      ...
      else
      {
        ...
        RCC_Clocks->SYSCLK_Frequency = (((uint32_t)8000000) / prediv1factor) * pllmull; 
      }      
      break;
    default:  
      RCC_Clocks->SYSCLK_Frequency = ((uint32_t)8000000);
