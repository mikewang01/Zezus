...
#line 56 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_crc.c"
...
#line 57 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_crc.c"
...
uint8_t CRC_GetIDRegister(void)
{
  return (((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00003000))->IDR);
}
