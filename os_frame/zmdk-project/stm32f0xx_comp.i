...
#line 99 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_comp.c"
...
#line 100 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_comp.c"
...
void COMP_DeInit(void)
{
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR = ((uint32_t)0x00000000);     
}
...
void COMP_Init(uint32_t COMP_Selection, COMP_InitTypeDef* COMP_InitStruct)
{
  ...
  tmpreg = ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR;
  ...
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR = tmpreg;  
}
...
void COMP_Cmd(uint32_t COMP_Selection, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR |= (uint32_t) (1<<COMP_Selection);
  }
  else
  {
     
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR &= (uint32_t)(~((uint32_t)1<<COMP_Selection));
  }
}
...
void COMP_SwitchCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR |= (uint32_t) (((uint32_t)0x00000002));
  }
  else
  {
...
uint32_t COMP_GetOutputLevel(uint32_t COMP_Selection)
{
  ...
  if ((((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR & (((uint32_t)0x00004000)<<COMP_Selection)) != 0)
  {
...
void COMP_WindowCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR |= (uint32_t) ((uint32_t)0x00800000);
  }
  else
  {
...
void COMP_LockConfig(uint32_t COMP_Selection)
{
  ...
  ((COMP_TypeDef *) (((uint32_t)0x40000000) + 0x0001001C))->CSR |= (uint32_t) (((uint32_t)0x00008000)<<COMP_Selection);
}
