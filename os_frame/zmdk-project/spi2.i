...
#line 15 "..\\drivers\\stm32f051x\\bus\\spi2.c"
...
#line 16 "..\\drivers\\stm32f051x\\bus\\spi2.c"
#line 17 "..\\drivers\\stm32f051x\\bus\\spi2.c"
#line 18 "..\\drivers\\stm32f051x\\bus\\spi2.c"
...
#line 19 "..\\drivers\\stm32f051x\\bus\\spi2.c"
...
os_err_t spi2_register(u16 task_id)
{
    ...
    return os_device_register(&(spi_dev->os_device), "SPI2", OS_DEVICE_FLAG_INACTIVATED);
...
{  	 
    ...
    gpio_pin_altset(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 15 , ((uint8_t)0x00));
    
    gpio_pin_altset(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 13  , ((uint8_t)0x00));
    
     
    gpio_speed_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 15 , GPIO_Speed_Level_3 );
    
    gpio_speed_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 13  , GPIO_Speed_Level_3 );
    
    
     
    gpio_outtype_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 15 , GPIO_OType_PP);
    
    gpio_outtype_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 13 , GPIO_OType_PP);
    
    
    gpio_outmode_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 15 , GPIO_Mode_AF);
    gpio_outmode_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 14 , GPIO_Mode_AF);
    gpio_outmode_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 13 ,  GPIO_Mode_AF);
    
     
    gpio_pupdr_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 15 , GPIO_PuPd_UP);
    
    gpio_pupdr_set(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) , 13 , GPIO_PuPd_UP);
    
    
    
    if(spi_dev->mode != spi_tx_only)
    {
        gpio_pin_altset(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)) ,  14 , ((uint8_t)0x00));
    ...
    tmpreg = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->CR1;
    ...
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->CR1 = (tmpreg); 
     
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->CRCPR = 7;
    
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->CR2  = (7<<8);
    
     
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->CR1 |= ((uint16_t)0x0104);
    
     
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->I2SCFGR &= (uint16_t)~((uint16_t)((uint16_t)0x0800));
     	
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->CR1 |=((uint16_t)0x0040); 
...
static os_size_t  spi2_write(os_device_t* dev, os_off_t pos, const void *buffer, os_size_t size)
{
    u32 spixbase = (u32)((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)); 
    spixbase += 0x0C;
    ...
    }else
    {
        ...
        while(size>0)
        {
            ...
            *(volatile u8 *) spixbase = *(char*)temp;
            temp++;
            size--;
            while(!(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))->SR&(1<<1)));
        }
    }
