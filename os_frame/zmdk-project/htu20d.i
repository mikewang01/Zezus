...
#line 15 "..\\drivers\\stm32f051x\\misc\\htu20d\\htu20d.c"
...
#line 50 "..\\incs\\driver\\stm32f051x\\htu20d.h"
...
#line 16 "..\\drivers\\stm32f051x\\misc\\htu20d\\htu20d.c"
#line 17 "..\\drivers\\stm32f051x\\misc\\htu20d\\htu20d.c"
#line 18 "..\\drivers\\stm32f051x\\misc\\htu20d\\htu20d.c"
...
#line 578 "..\\incs\\asm-arm\\stm32f0xx\\stm32f0xx_spi.h"
...
#line 19 "..\\drivers\\stm32f051x\\misc\\htu20d\\htu20d.c"
...
static htu20_device *htu20_dev=0;
...
os_err_t htu20_register(u16 task_id)
{
    ...
    htu20_dev->dev_adress        =  0X40;
    
    htu20_dev->os_device.rx_indicate = htu20_rx_indicator;
    
    return os_device_register(&(htu20_dev->os_device), "HTU20", OS_DEVICE_FLAG_INACTIVATED);
...
{  	 
    ...
    GPIO_InitStruct.GPIO_Pin = (1<<6) | (1<<7);
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;
    GPIO_InitStruct.GPIO_Speed = GPIO_Speed_Level_3;
    GPIO_InitStruct.GPIO_OType = GPIO_OType_OD;
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400)) , &GPIO_InitStruct);
    
     
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400)) , &GPIO_InitStruct);
    
     
    GPIO_PinAFConfig( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400)) , 6 , ((uint8_t)0x01)); 
     
    GPIO_PinAFConfig( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400)) , 7 , ((uint8_t)0x01));	 
    
     
    I2C_DeInit(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)));
     
    I2C_InitStruct.I2C_Mode = ((uint32_t)0x00000000);
    I2C_InitStruct.I2C_AnalogFilter = ((uint32_t)0x00000000);
    I2C_InitStruct.I2C_DigitalFilter = 0x00;
    I2C_InitStruct.I2C_OwnAddress1 =0x00;
    I2C_InitStruct.I2C_Ack = ((uint32_t)0x00000000);
    I2C_InitStruct.I2C_AcknowledgedAddress = ((uint32_t)0x00000000);	
    I2C_InitStruct.I2C_Timing = 0x10805E89;
    
     
    I2C_Cmd(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) , ENABLE);
     
    I2C_Init(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) , &I2C_InitStruct);
...
static os_err_t  htu20_control(os_device_t* dev, u8 cmd, void *args)
{
    ...
    case 0Xe5: if(SUCCESS == htu20_read_data(htu20_dev->dev_adress , 0Xe5 , buffer , 3))
        {
    ...
    case 0Xe3: if(SUCCESS == htu20_read_data(htu20_dev->dev_adress , 0Xe3 , buffer , 3))
        {
            temp = (buffer)[0]<<8|(buffer[1]&(~0x03));
    ...
    case 0XE7:       if(SUCCESS == htu20_read_data(htu20_dev->dev_adress , 0XE7       , buffer , 1))
        {
            ((htu20_data *)args)->user_res_content = buffer[0];
            
        }break;
        
    case 0XE6:      htu20_send_data(htu20_dev->dev_adress , 0XE6      , &(((htu20_data *)args)->user_res_content) );  break;
         			
    case 0XFE:  						 htu20_send_data(htu20_dev->dev_adress , 0XFE , buffer );          break;    
    default:break;
...
static os_err_t htu20_read_data(u16 deviceAddr , u8 command , u8 *buffer , size_t size)
{
    ...
    I2C_NumberOfBytesConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), 1);
    
    I2C_SlaveAddressConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), (deviceAddr<<1));
    
    I2C_MasterRequestConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), ((uint16_t)0x0000));
    
    I2C_GenerateSTART(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), ENABLE);           
    
     	
    I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) , command);  
    
    count_down = ((u32)(10 * ((u32)0x1000)));
    
    while(!I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), ((uint32_t)0x00000001))) 
    {
        if(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)),((uint32_t)0x00000010)))
        {
            I2C_ClearFlag(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)),((uint32_t)0x00000010));
            I2C_ClearFlag(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)),((uint32_t)0x00000020));
            return ERROR;
        }
        if(count_down-- == 0)
        {
    ...
    do{
        ...
        I2C_NumberOfBytesConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) , size);
        
        
        I2C_MasterRequestConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) , ((uint16_t)0x0400));
    ...
    }while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) ,((uint32_t)0x00000010))==SET);
    ...
    {	
        ...
        while(!I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), ((uint32_t)0x00000004)))
        {
            if(count_down-- == 0)
                return  ERROR;
        }
        
        buffer[count]=I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)));
        size --;
        count ++;
    }	
    
    count_down = ((u32)(10 * ((u32)0x1000)));
    while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) ,  ((uint32_t)0x00000040)) == RESET)
    {
        if(count_down-- == 0)
            return  ERROR;
    }
    ...
    I2C_GenerateSTOP(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), ENABLE); 
    
    count_down = ((u32)(10 * ((u32)0x1000)));		
    while(I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), ((uint32_t)0x00000020)) == RESET)
    {
        if(count_down-- == 0)
            return  ERROR;
    }   
...
static os_err_t htu20_send_data(u16 deviceAddr , u8 command , u8 *buffer )
{
    ...
    if(command == 0XE6)
    {
        I2C_NumberOfBytesConfig(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), 2);
    }
    ...
    {	
        ...
        I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) , buffer[0]);  
