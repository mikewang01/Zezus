...
#line 584 "..\\incs\\asm-arm\\stm32f0xx\\stm32f0xx_usart.h"
...
#line 82 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_usart.c"
#line 83 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_usart.c"
#line 84 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_usart.c"
...
void USART_DeInit(USART_TypeDef* USARTx)
{
  ...
  {
    if  (USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004400)))
    {
...
void USART_AutoBaudRateNewRequest(USART_TypeDef* USARTx)
{
  ...
  USARTx->ISR &= (uint32_t)~((uint32_t)((uint32_t)0x00008000));
}
