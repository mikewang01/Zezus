...
#line 27 "..\\drivers\\stm32f051x\\misc\\relay\\relay.c"
#line 28 "..\\drivers\\stm32f051x\\misc\\relay\\relay.c"
...
static relay_device *relay_dev=0;
...
os_err_t relays_register(u16 task_id)
{
    ...
    return os_device_register(&(relay_dev->os_device), 	"RELAY", OS_DEVICE_FLAG_INACTIVATED);
...
static os_err_t  relays_control(os_device_t* dev, u8 cmd, void *args)
{
    ...
    }else
    {
        ...
        relay_device * relay_dev=(relay_device *)( (char *)__mptr - ((size_t) &((usart_device *)0)->os_device));
...
static os_err_t relay_open_close(u8 relay_num,u8 cmd)
{
    ...
    if(relay_num==relay1)
    {
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x08000000) + 0x00000400)+12) &0xFFFFF)<<5)+(11<<2))))=cmd;
