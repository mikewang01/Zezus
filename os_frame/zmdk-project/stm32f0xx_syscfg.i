...
#line 49 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_syscfg.c"
...
#line 50 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_syscfg.c"
...
void SYSCFG_DeInit(void)
{
  ...
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR2 |= (uint32_t) ((uint32_t)0x00000100);
}
...
FlagStatus SYSCFG_GetFlagStatus(uint32_t SYSCFG_Flag)
{
  ...
  if ((((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR2 & ((uint32_t)0x00000100)) != (uint32_t)RESET)
  {
...
void SYSCFG_ClearFlag(uint32_t SYSCFG_Flag)
{
  ...
  ((SYSCFG_TypeDef *) (((uint32_t)0x40000000) + 0x00010000))->CFGR2 |= (uint32_t) SYSCFG_Flag;
}
