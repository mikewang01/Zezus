...
#line 15 "..\\task\\usertask\\user_task.c"
#line 16 "..\\task\\usertask\\user_task.c"
#line 1 "..\\task\\usertask\\usertask.h"
...
#line 17 "..\\task\\usertask\\user_task.c"
#line 18 "..\\task\\usertask\\user_task.c"
...
void process_event(u16 taskid , u16 msg_num , smessage* msg)
{
    ...
    do{
        ...
        {
        case 0x01: 
            if(((msg->event)&0x01)==0x01)
            {
                
                
                
                os_timer_period(taskid,0x03,500,0);
                
                os_timer_period(taskid,0x06,125,0);
            ...
            if((msg->event&0X01)==0X01)
            {
                ...
                if(relay_data->relay_num==relay1)
                {
...

                    {
                        ...
                        os_timer_expired(taskid,0X08,relay_data->time_open,0);
                    }
                }
...
void  task_demo_init()
{
    ...
    send_message(this_task_id,0x04,0x01,0x01,0,(u16)0);
}
