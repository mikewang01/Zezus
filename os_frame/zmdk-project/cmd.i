...
#line 5 "..\\kernel\\Q_Shell\\cmd.c"

unsigned char  crc16_on_off=0;
unsigned short Var2;
unsigned int   Var3;

static const char qsh_var_crc16_on_off_name[] = "crc16_on_off"; static const char qsh_var_crc16_on_off_desc[] = "crc16_on_off on:0 off:1"; static const char qsh_var_crc16_on_off_typedesc[] = "u8"; QSH_RECORD qsh_var_crc16_on_off_record __attribute__((section("qShellVarTab"))) = { qsh_var_crc16_on_off_name, qsh_var_crc16_on_off_desc, (void *)&crc16_on_off, qsh_var_crc16_on_off_typedesc };
static const char qsh_var_Var2_name[] = "Var2"; static const char qsh_var_Var2_desc[] = "unsigned char  Var2"; static const char qsh_var_Var2_typedesc[] = "u16"; QSH_RECORD qsh_var_Var2_record __attribute__((section("qShellVarTab"))) = { qsh_var_Var2_name, qsh_var_Var2_desc, (void *)&Var2, qsh_var_Var2_typedesc };
static const char qsh_var_Var3_name[] = "Var3"; static const char qsh_var_Var3_desc[] = "unsigned char  Var3"; static const char qsh_var_Var3_typedesc[] = "u32"; QSH_RECORD qsh_var_Var3_record __attribute__((section("qShellVarTab"))) = { qsh_var_Var3_name, qsh_var_Var3_desc, (void *)&Var3, qsh_var_Var3_typedesc };
...
static const char qsh_fun_Add_name[] = "Add"; static const char qsh_fun_Add_desc[] = "unsigned int Add(unsigned a,unsigned b)"; QSH_RECORD qsh_fun_Add_record __attribute__((section("qShellFunTab"))) = { qsh_fun_Add_name, qsh_fun_Add_desc, (void *)&Add, 0 };
...
static const char qsh_fun_PutString_name[] = "PutString"; static const char qsh_fun_PutString_desc[] = "unsigned int PutString(char *Str)"; QSH_RECORD qsh_fun_PutString_record __attribute__((section("qShellFunTab"))) = { qsh_fun_PutString_name, qsh_fun_PutString_desc, (void *)&PutString, 0 };
...
static const char qsh_fun_list_timer_name[] = "list_timer"; static const char qsh_fun_list_timer_desc[] = "long list_timer()"; QSH_RECORD qsh_fun_list_timer_record __attribute__((section("qShellFunTab"))) = { qsh_fun_list_timer_name, qsh_fun_list_timer_desc, (void *)&list_timer, 0 };
...
static const char qsh_fun_list_device_name[] = "list_device"; static const char qsh_fun_list_device_desc[] = "long list_device()"; QSH_RECORD qsh_fun_list_device_record __attribute__((section("qShellFunTab"))) = { qsh_fun_list_device_name, qsh_fun_list_device_desc, (void *)&list_device, 0 };
...
static const char qsh_fun_relay_control_name[] = "relay_control"; static const char qsh_fun_relay_control_desc[] = "os_err_t relay_control(u8 relay_no,u8 cmd) relayno:1~4;cmd 1:open 0 closed"; QSH_RECORD qsh_fun_relay_control_record __attribute__((section("qShellFunTab"))) = { qsh_fun_relay_control_name, qsh_fun_relay_control_desc, (void *)&relay_control, 0 };
...
static const char qsh_fun_list_mem_name[] = "list_mem"; static const char qsh_fun_list_mem_desc[] = "os_err_t list_mem()"; QSH_RECORD qsh_fun_list_mem_record __attribute__((section("qShellFunTab"))) = { qsh_fun_list_mem_name, qsh_fun_list_mem_desc, (void *)&list_mem, 0 };
