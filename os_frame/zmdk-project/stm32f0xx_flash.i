...
#line 77 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_flash.c"
...
#line 78 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_flash.c"
...
FLASH_Status FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  ...
  if(status == FLASH_COMPLETE)
  {
    ...
    ((OB_TypeDef *) ((uint32_t)0x1FFFF800))->USER = (uint16_t)((uint16_t)(OB_IWDG | OB_STOP) | (uint16_t)(OB_STDBY | 0xF8));
