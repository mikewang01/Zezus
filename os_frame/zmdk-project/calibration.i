...
#line 21 "..\\kernel\\Q_Shell\\calibration.c"
...
#line 22 "..\\kernel\\Q_Shell\\calibration.c"
...
#line 23 "..\\kernel\\Q_Shell\\calibration.c"
...
#line 24 "..\\kernel\\Q_Shell\\calibration.c"
...
#line 25 "..\\kernel\\Q_Shell\\calibration.c"
    ...
    }else if(current_status == frame_preended)
    {
        if(data == (u8)(~0x55))
        {
            ...
            *buffer_ptr =  data;
            ...
            send_message(0 , 0x04 , 0x01 , 0X03 ,( void*)(buffer_cmd) , sizeof(data_packge));
