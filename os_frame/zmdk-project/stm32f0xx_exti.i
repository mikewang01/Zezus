...
#line 67 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_exti.c"
...
#line 68 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_exti.c"
...
ITStatus EXTI_GetITStatus(uint32_t EXTI_Line)
{
  ...
  enablestatus =  ((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->IMR & EXTI_Line;
  if (((((EXTI_TypeDef *) (((uint32_t)0x40000000) + 0x00010400))->PR & EXTI_Line) != (uint32_t)RESET) && (enablestatus != (uint32_t)RESET))
  {
    bitstatus = SET;
  }
  else
