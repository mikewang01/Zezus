...
#line 80 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_i2c.c"
...
#line 81 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_i2c.c"
...
#line 82 "..\\arch\\arm\\stm32f05x\\lib\\src\\stm32f0xx_i2c.c"
...
void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->CR1 |= ((uint32_t)0x00002000);
  }
  else
  {
     
    I2Cx->CR1 &= (uint32_t)~((uint32_t)((uint32_t)0x00002000));
  }
}
