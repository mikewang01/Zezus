...
#line 1 "..\\incs\\driver\\stm32f051x\\led.h"
#line 40 "..\\incs\\driver\\stm32f051x\\led.h"
...
#line 14 "..\\drivers\\stm32f051x\\misc\\LED\\led.c"
...
static GPIO_TypeDef *led_ports[]={((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)) , ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000)) };

static const u8 led_pins[]={11 , 12};
...
void led_init(void)
{
    ...
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->OSPEEDR &= ~(((uint32_t)0x00000003) << (11 * 2));
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->OSPEEDR |= ((u32)(GPIO_Speed_Level_2) <<(11 * 2));
    
     
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->OTYPER &= ~((((uint32_t)0x00000001)) << ((u16) 11));
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->OTYPER |= (u16)(GPIO_OType_PP) << ((u16) 11);
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->MODER  &= ~(((uint32_t)0x00000003) << ((u16) 11 * 2));
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->MODER |= ((u32)GPIO_Mode_OUT) << ((u16) 11 * 2);
    
     
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->PUPDR &= ~(((uint32_t)0x00000003) << ((u16)(11 * 2)));
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->PUPDR |= ((uint32_t)0x00000003) << ((u16) 11 * 2);
    
    
     
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->OSPEEDR &= ~(((uint32_t)0x00000003) << (3 * 2));
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->OSPEEDR |= ((u32)(GPIO_Speed_Level_2) <<(3 * 2));
    
     
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->OTYPER &= ~((((uint32_t)0x00000001)) << ((u16) 3));
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->OTYPER |= (u16)(GPIO_OType_PP) << ((u16) 3);
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->MODER  &= ~(((uint32_t)0x00000003) << ((u16) 3 * 2));
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->MODER |= ((u32)GPIO_Mode_OUT) << ((u16) 3 * 2);
    
     
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->PUPDR &= ~(((uint32_t)0x00000003) << ((u16)(3 * 2)));
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->PUPDR |= ((uint32_t)0x00000003) << ((u16) 3 * 2);
    
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->BSRR = 1<<3;
...
os_err_t  leds_control(os_device_t* dev, u8 cmd, void *args)
{
    ...
    switch(cmd)
    {
    case led_on:  	led_ports[led_num]->BRR  = (1<<led_pins[led_num]) ;	 break;
    case led_off: 	led_ports[led_num]->BSRR = (1<<led_pins[led_num]) ;   break;
        
    case led_trigger: if((led_ports[led_num]->ODR)&(1<<led_pins[led_num]))
        {
            led_ports[led_num]->ODR&=~(1<<led_pins[led_num]);
