...
#define EEPROM_START_ADDRESS  ((uint32_t)0x0800E000) /* EEPROM emulation start address:
                                                       ...
                                                       the last two sector at the end of flash*/
...
typedef struct
{
	os_device_t os_device;/*parent struct ftom device*/
	u16 register_taskid;  /*rember the id of task resistering*/
	u32 pclk2 ;           /*clock driving this module*/
	u32 bound ;
}eeprom_device;
