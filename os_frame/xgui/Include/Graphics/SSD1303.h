 ...
 *****************************************************************************/
#ifndef _SSD1303_OLED_H
#define _SSD1303_OLED_H
...
#define WriteCommand(cmd)		DelayMs(1);

#define WriteFastCommand(cmd)	PMPDelay()
...
*
********************************************************************/
#define WriteData(writeByte) 	Nop();PMPDelay();
...
*
********************************************************************/
#define ReadData(readByte)		PMPDelay();
...
//	WriteFastCommand(page);\
//	WriteFastCommand(lowerAddr);\
//	WriteFastCommand(higherAddr);
